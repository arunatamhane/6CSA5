...
public class LinkText {
	public static void main(String[] args) {
		...
		driver.findElement(By.linkText("Engineering Blog"));
		System.out.println(" 1 found");
		
		driver.get("https://www.flipkart.com/");
		driver.findElement(By.linkText("Terms of Use"));
		...
		driver.findElement(By.linkText("Contact GitHub"));
		...
		driver.findElement(By.linkText("Cloud computing with AWS Course"));
		...
		driver.findElement(By.linkText("Become a Partner"));
		System.out.println(" 7 found");
		
		driver.get("https://www.swiggy.com/");
		driver.findElement(By.linkText("Kolkata"));
		...
		driver.findElement(By.linkText("UK"));
